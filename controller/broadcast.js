...
const fileKeys  = ['img_broadcast_url'];
...
exports.get = (req, res) => {
  ...
  models.broadcast.findAndCountAll({
    offset: offset,
    limit: limit,
    order: [['id', 'DESC']]
  })
...
exports.update = (req, res) => {
  ...
  models.broadcast.findOne({
    attributes: fileKeys, 
    where: {id: id}, 
    raw: true 
  })
  .then((result) => {
    models.broadcast.update(data, {where: {id: id}})
    .then(() => {
      res.end();
...
exports.delete = (req, res) => {
  ...
  .then((result) => {
    models.broadcast.destroy({where: {id: ids}})
    .then(() => {
      res.end();
