...
const fileKeys  = ['img_channel_url'];
...
exports.get = (req, res) => {
  ...
  models.channel.findAndCountAll({
    offset: offset,
    limit: limit,
    order: [['id', 'DESC']]
  })
...
exports.update = (req, res) => {
  ...
  .then((result) => {
    models.channel.update(data, {where: {id: id}})
    .then(() => {
      res.end();
...
exports.delete = (req, res) => {
  ...
  .then((result) => {
    models.channel.destroy({where: {id: ids}})
    .then(() => {
      res.end();
